...
// Used for grouping in the UI achievement gallery.
// ─────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────
// STAT TYPE
// Used by stat-based achievement conditions.
// Mirrors the fields in Stats but as an enum so conditions
// can reference a stat by name rather than by field access.
// ─────────────────────────────────────────────────────
...
// Used by WorkoutTimeOfDay condition — before or after a given hour.
// ─────────────────────────────────────────────────────
...
// Sealed class — one subclass per distinct condition shape.
// Every achievement has exactly one condition.
// Complex achievements (e.g. The Big Four) use conditions
// that accept a list of targets.
// ─────────────────────────────────────────────────────
...
sealed class AchievementCondition {
    ...
    // ── CARDIO ────────────────────────────────────────────
    // Total cardio sessions >= count (optionally filtered by CardioExerciseType)
    ...
    // ── PERSONAL RECORDS ──────────────────────────────────
    // PRs set in X different exercises (min 20% improvement to count)
    ...
    // ── BEHAVIOURAL / SECRET ──────────────────────────────
    // Workout logged before/after a specific hour (0–23)
...
// The static definition of an achievement — what it is,
// what triggers it, and what it rewards.
...
// The runtime state for one achievement for one user.
// Stored per user — tracks unlock status and progress.
// ─────────────────────────────────────────────────────
